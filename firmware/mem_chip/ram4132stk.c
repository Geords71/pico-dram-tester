...
#include "ram4132stk.pio.h"
#include "mem_chip.h"

#define RAM4132STK_DELAY_SET_ROWS 4

static const delay_sets_t ram4132stk_delay_sets = {
    .len = RAM4132STK_DELAY_SET_ROWS,
    .wid = RAM4132STK_DELAY_SET_COLS,
    .list = {
...
void ram4132stk_teardown_pio()
{
    pio_sm_set_enabled(pio, sm, false);
    pio_remove_program_and_unclaim_sm(&ram4132stk_program, pio, sm, offset);
}

int ram4132stk_ram_read(int addr)
{
    uint d;
...
void ram4132stk_ram_write(int addr, int data)
{
...
static const mem_chip_variants_t ram4132stk_variants = {
    .len = 1,
    .list = {
        {"4132stk", ram4132stk_ram_read, ram4132stk_ram_write},
    },
};

void ram4132stk_setup_pio(uint speed_grade, uint variant);

// This RAM chip configuration
const mem_chip_t ram4132stk_chip = {
    .setup_pio = ram4132stk_setup_pio,
    .teardown_pio = ram4132stk_teardown_pio,
    .ram_read = ram4132stk_ram_read,
    .ram_write = ram4132stk_ram_write,
    .mem_size = 32768,
    .bits = 1,
    .variants = &ram4132stk_variants,
    .name = "4132 (32Kx1, stacked)",
    .short_name = "4132stk",
    .timing_family = "ram4132",
    .delay_sets = ram4132stk_delay_sets,
...
void ram4132stk_setup_pio(uint speed_grade, uint variant)
{
    get_ram_config(ram4132stk_chip);

    const uint8_t *delay_set = ram4132stk_delay_sets.list[speed_grade];

    uint pin = 5;
    bool rc = pio_claim_free_sm_and_add_program_for_gpio_range(
        get_patched_program(
            &ram4132stk_program, delay_set, RAM4132STK_DELAY_SET_COLS
        ),
    ...
    pio_sm_config c = ram4132stk_program_get_default_config(offset);
